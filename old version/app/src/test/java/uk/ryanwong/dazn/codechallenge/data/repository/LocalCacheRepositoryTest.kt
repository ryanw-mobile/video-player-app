...
internal class LocalCacheRepositoryTest {
    ...
    @Test
    fun nonEmptyLocal_syncEvents_updatedEvents() =
        runTest {
    ...
    @Test
    fun nonEmptyLocal_syncEmptyRemoteEvents_emptyLocalEvents() =
        runTest {
            // Given the localDataSource has event1
    ...
    @Test
    fun errorRemote_syncEvents_throwException() =
        runTest {
    ...
    @Test
    fun nonEmptyLocal_syncSchedules_updatedSchedules() =
        runTest {
    ...
    @Test
    fun errorRemote_syncSchedules_throwException() =
        runTest {
            // Given the remoteDataSource set to return error
            val exceptionMessage = "test exception"
            remoteDataSource.setShouldReturnIOException(true, exceptionMessage)
